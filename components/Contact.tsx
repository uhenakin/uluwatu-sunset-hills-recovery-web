...
export default function Contact() {
  ...
  return (
    <Reveal>
      <section id="contact" className="responsive-section-contact" style={{ 
        minHeight: '100vh', 
        background: 'linear-gradient(to bottom, #ffffff 0%, #faf8ef 15%, #faf8ef 100%)', 
        display: 'flex',
        ...
        <p className="contact-desc" style={{
          ...
          <span style={{ display: 'block', marginTop: '28px', color: '#d5a15c', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', fontSize: '0.9rem' }}>
        ...
        <div style={{ 
          ...
          <div style={{ width: '35px', height: '1.5px', backgroundColor: 'var(--accent-gold)', marginBottom: '8px', opacity: 0.6 }} />
          <h4 className="font-luxury" style={{ fontSize: '1.4rem', color: '#d5a15c', marginBottom: '4px', letterSpacing: '1px' }}>
            Visit Us
          </h4>
          <p style={{ color: '#2c2c2c', opacity: 0.8, fontSize: '0.9rem', lineHeight: '1.4', letterSpacing: '1px' }}>
            Set in the hills of Uluwatu, Bali
          </p>
          <p style={{ color: '#d5a15c', fontStyle: 'italic', opacity: 0.95, fontSize: '0.85rem', marginTop: '6px', letterSpacing: '0.5px' }}>
            Restore your mind, body, and soul above the Indian Ocean.
          </p>
          <p style={{ color: '#2c2c2c', opacity: 0.85, fontSize: '0.85rem', marginTop: '6px', letterSpacing: '1px', fontWeight: 500 }}>
        ...
        <style jsx>{`
          ...
          .contact-item:hover {
            ...
            box-shadow: 0 12px 25px rgba(213, 161, 92, 0.25);
          }
